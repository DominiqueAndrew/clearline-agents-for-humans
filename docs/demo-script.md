...
5. **Close on the boundary (1:35–2:00).** Point to the audit feed, then refresh the page once. “Every automated or human decision is visible, and the approval and hold remain after refresh because Clearline persists its local state. The model can help explain a case in live mode, but the policy gate and human approval are the control plane.”
