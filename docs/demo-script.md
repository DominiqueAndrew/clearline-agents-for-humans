...
1. **Open the product (0:00–0:15).** “Clearline is for the person who approves every invoice at a small company. It runs in the background, so the inbox is not their job.” Point to `Quiet mode on`, `8 invoices`, and the `5 filed / 3 need you` split.
